...
生产版采用 Windows 11 风格的 **Acrylic / 液态玻璃** 设计：
...
- 任务栏覆盖图标和系统 Acrylic 效果会根据 Windows 版本和系统设置降级
